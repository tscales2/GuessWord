...
def wordpicker(m):
    ...
    while n != jack:
        if n.isalpha():
            ...
            n = input('Press enter')
            count += 1
            if count == 5 or jack == n:
                print('Sorry, the word was ', jack)
                break
            elif count == 4:
                if lenOfWord <= 5 or jack == n:
                    print('Sorry, the word was ', jack)
                    break
                else:
                    print(
                        'Try again. Here\'s a hint: The fifth letter is ' + jack[4])
            elif count == 3 or jack == n:
                if lenOfWord <= 4:
                    print('Sorry, the word was ', jack)
                    break
                else:
                    print(
                        'Try again. Here\'s a hint: The fourth letter is ' + jack[3])
            elif count == 2 or jack == n:
                if lenOfWord <= 3:
                    print('Sorry, the word was ', jack)
                    break
                else:
                    print(
                        'Try again. Here\'s a hint: The third letter is ' + jack[2])
            elif count == 1 or jack == n:
                print(
                    'Try again. Here\'s a hint: The second letter is ' + jack[1])
        else:
...
def groupOfWords():
    ...
    wordstochoose = input(
        'Enter either a letter, in all caps, for a list of words starting with that letter \nor type ALL for the entire list of words: \n')
    if wordstochoose == 'A':
